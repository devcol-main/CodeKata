| Solved Date: 2026-06-03-Wed |

[Problem Link](https://school.programmers.co.kr/learn/courses/30/lessons/161989?language=cpp)
...
* n = total num
* m = numers of section will be paint on one brush painting
* section = section to point
* result =  페인트칠해야 하는 최소 횟수
...
* vector 에서 for(int i : vector) 를 다른 방식으로 처음 써본거 같다.
* 처음에 일반적으로 생각했던 for문은 너무 정신없어서 이것 역시 AI 참고 했는데 너무 깔끔해서 이걸로 올렸다.