| Solved Date: 2026-05-30-Sat |

[Problem Link](https://school.programmers.co.kr/learn/courses/30/lessons/138477?language=cpp)
...
---
### 힌트
* vector custom sort: sort(temp.begin(), temp.end(), [](int a, int b) { return a > b; });
* vector:  .size(), .back()
 ...
 * 예를 들어, `k` = 3이고, 7일 동안 진행 
 * 진행된 점수: [10, 100, 20, 150, 1, 100, 200]이라면, 
 * 발표된 점수: [10, 10, 10, 20, 20, 100, 100]입니다.
